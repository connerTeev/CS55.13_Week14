...
const dataURL =
  'https://dev-teevan-fall-cs55-13.pantheonsite.io/wp-json/twentytwentyone-child/v1/things';

export async function getSortedThingsPostsList() {
...
export async function getThingsPostIds() {
  //get filepath to JSON
  //const filePath = path.join(pathToData, 'fruits.json');
...
export async function getThingsPostsData(idRequested) {
  //get filepath to json
  //const filePath = path.join(pathToData, 'fruits.json');
